...
> **Status: v0.2.0 — Day 1 spine foundation complete.** Project skeleton, data model, seed, CI pipeline, and test infrastructure are in place. UI ships in Day 2.
...
| [SSY-INTERVIEW-PREP-JOE-ALEXANDER.md](docs/research/SSY-INTERVIEW-PREP-JOE-ALEXANDER.md) | 1st-stage interview prep — interviewer context, likely questions, strategy |
